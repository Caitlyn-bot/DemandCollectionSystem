            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                ...
                <div class="panel panel-default" id="shAll">
                    ...
                    <div id="collapseThree" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingThree">
                        <div class="panel-body">
                            <ul class="list-group">
                                <a id="xssh" class="list-group-item active" href="${pageContext.request.contextPath}/examine/xssh.jsp">形式审核</a>
...
<div class="modal fade" id="updateUserModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/xsshServlet">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-bordered" id="shenhetable">
                        ...
                        <tr class="row">
                            <td class="col-sm-2 text-center"  >
                                <label class="control-label" for="rSFSH">
                                    <span style="color: red">审核意见</span>
                                </label>
                            </td>
                            <td colspan="3">
                                <select class="form-control " id="rSFSH" name="SFSH">
                        ...
                        <tr class="text-center row">
                            ...
                            <td colspan="3">
                                <textarea class="form-control" rows="8" name="XSSCYJ" id="XSSCYJ" placeholder="形式审核意见"></textarea>
                            </td>
                        </tr>
                        <tr class="row">
                            <td class="col-sm-2 text-center" rowspan="2" id="glcslength">
                                <label class="control-label" for="GLCS">
                                    <span style="color: red">管理处室</span>
                                </label>
                            </td>
                            <td colspan="3">
                                <input type="text" class="form-control" name="GLCS" id="GLCS" onkeyup="searchWord(this)" placeholder="输入编号即可获得提示">
                            </td>
                        </tr>
                        <table id="showGlcsTable" class="table table-bordered">
                                    ...
                                    $.post(
                                        ...
                                        function(data){
                                            ...
                                            if(data.length>0){
                                                ...
                                                glcslength
                                                //$("#glcslength").rowspan(data.length+1)
                                                for(var i=0;i<data.length;i++){
                                                    content+="<tr>"
                                                        +"<td  class='row' colspan='3'   onclick='clickFn(this)' onmouseover='overFn(this)' onmouseout='outFn(this)'>"
                                                        +data[i].bmmc
                                                        +"</td>"
                                                        +"</tr>";
                                                }
                                                $("#showGlcsTable ").append(content);
                                                //$("#showGlcs").css("display","block");
                                            }
