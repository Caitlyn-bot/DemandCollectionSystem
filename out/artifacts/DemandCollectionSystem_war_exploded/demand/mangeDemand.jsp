                    ...
                    <div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo">
                        <div class="panel-body">
                            <ul class="list-group">
                                ...
                                <a id="demandMange" class="list-group-item active" href="${pageContext.request.contextPath}/mangeDemandServlet">需求管理</a>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#home" aria-controls="home" role="tab"
                               data-toggle="tab">需求列表</a>
                        </li>
                        <li role="presentation">
                            <a id="addUserBtn">添加需求</a>
                        </li>
                    </ul>
                        ...
                        <div role="tabpanel" class="tab-pane active" id="home">
                            ...
                            <table class="table table-bordered table-hover table-striped">
                                <tr>
                                    ...
                                    <c:forEach items="${requestScope.dcwjxxs}" var="dcwjxx" varStatus="s">
                                <tr class="text-center">
                                        ...
                                        <td>${dcwjxx.YJLX}</td>
                                        <td>
                                            <a onclick="updateUser('${dcwjxx.WJID}')" data-toggle="modal" data-target="#updateUserModal" class="btn btn-info btn-sm">修改</a>
                                            <script>
                                                function updateUser(id){
                                                    $.ajax({
                                                        type:"POST",
                                                        url:"queryMangeServlet",
                                                        data:{"WJID":id},
                                                        dataType:"json",
                                                        success:function(data){
                                                            $("#rWJID").val(data.wjid)
                                            ...
                                            <a onclick="deleteUser('${dcwjxx.WJID}');" href="" data-toggle="modal" data-target="#deleteUserModal" class="btn btn-danger btn-sm">删除</a>
                                            <script>
...
<div class="modal fade" id="addUserModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/addDemandServlet">
...
<div class="modal fade" id="updateUserModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/updateDemandServlet">
...
<div class="modal fade" id="deleteUserModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="${pageContext.request.contextPath}/deleteDcwjServlet">
                <input type="hidden" name="deleteWJID" id="deleteWJID">
            <div class="modal-body">
                您确认删除该需求
            </div>
            <div class="modal-footer">
