                    ...
                    <div id="collapseFour" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingFour">
                        <div class="panel-body">
                            <ul class="list-group">
                                ...
                                <a class="list-group-item active" href="${pageContext.request.contextPath}/report/zhjs.jsp">综合检索</a>
            ...
            <div class="col-sm-10">
                ...
                <div>
                    <form class="form-inline" target="hidden" id="searchForm">
                            ...
                            <tr class="row">
                                ...
                                <td class="col-sm-6">
                                    <div class="form-group">
                                        <label for="sfljs">检索条件</label>
                                        <select class="form-control" id="sfljs" name="sfljs">
                                            <option value=""></option>
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="stj" id="stj" placeholder="请输入条件">
                                    </div>
                                    <div class="form-group">
                                        <select class="form-control" id="sjsyq" name="sjsyq">
                                ...
                                <td class="col-sm-4">
                                    <button onclick="addStj()" class="btn btn-info">添加检索条件</button>
                                </td>
                            </tr>
                            <script>
                                var count=1;
                                function addStj() {
                                    if (count>5){
                                        ...
                                        var $option = $(
                                            "<tr class='row' id='countrow"+count+"'>"
                                            +"<td class='col-sm-2'>"
                                            +"<select class='form-control' id='jsgx"+count+"' name='jsgx"+count+"'>"
                                            +"<option value='and'>"
                                            +"AND"
                                            +"</option>"
                                            +"<option value='or'>"
                                            ...
                                            +"检索条件"
                                            +"</label>"
                                            +"<select class='form-control' id='sfljs"+count+"' name='sfljs"+count+"'>"
                                            +"<option value=''>"
                                            +"</option>"
                                            +"<option value='机构全称'>"
                                            +"机构全称"
                                            ...
                                            +"</div>"
                                            +"<div class='form-group'>"
                                            +"<input type='text' class='form-control' name='stj"+count+"' id='stj"+count+"' placeholder='请输入条件'>"
                                            +"</div>"
                                            +"<select class='form-control' id='sjsyq"+count+"' name='sjsyq"+count+"'>"
                                            +"<option value='模糊查询'>"
                                            +"模糊查询"
                                            +"</option>"
                                            +"<option value='模糊查询'>"
                                            ...
                                            +"</td>"
                                            +"<td class='col-sm-4'>"
                                            +"<button onclick='addStj()' class='btn btn-info'>"
                                            +"添加检索条件"
                                            +"</button>"
                                            +"<button onclick='delStj(this)' class='btn btn-info'>"
                                            +"删除检索条件"
                                            +"</button>"
                                            +"</td>"
                                            +"</tr>");
                        ...
                        <br>
                        <div class="form-group">
                            <label for="sXSSH">形式审核是否通过</label>
                            <select class="form-control " id="sXSSH" name="sXSSH">
                                <option value="否">否</option>
                                <option value="是">是</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="sBMSH">部门审核是否通过</label>
                            <select class="form-control " id="sBMSH" name="sBMSH">
                                <option value="否">否</option>
                                <option value="是">是</option>
                            </select>
                        </div>
                        ...
                        <script>
                            function search() {
                                var sql="select * from dcwjxx where 1=1 "
                                var sfljs=$("#sfljs").val();
                                var stj = $("#stj").val();
                                var sjsyq = $("#sjsyq").val();
                                var jsgx1=$("#jsgx1").val();
                                var sfljs1=$("#sfljs1").val();
                                var stj1=$("#stj1").val();
                                var sjsyq1 = $("#sjsyq1").val();
                                var jsgx2=$("#jsgx2").val();
                                var sfljs2=$("#sfljs2").val();
                                var stj2=$("#stj2").val();
                                var sjsyq2 = $("#sjsyq2").val();
                                var jsgx3=$("#jsgx3").val();
                                var sfljs3=$("#sfljs3").val();
                                var stj3=$("#stj3").val();
                                var sjsyq3 = $("#sjsyq3").val();
                                var jsgx4=$("#jsgx4").val();
                                var sfljs4=$("#sfljs4").val();
                                var stj4=$("#stj4").val();
                                var sjsyq4 = $("#sjsyq4").val();
                                var jsgx5=$("#jsgx5").val();
                                var sfljs5=$("#sfljs5").val();
                                var stj5=$("#stj5").val();
                                var sjsyq5 = $("#sjsyq5").val();
                                var sXSSH = $("#sXSSH").val();
                                var sBMSH = $("#sBMSH").val();
                                if (sXSSH=="否"){
                                    sql+="and SFSH=0 ";
                                ...
                                if (sfljs!=null&&sfljs!=""&&stj!=null&&stj!=""){
                                    sql+="  and ";
                                    type(sfljs,stj,sjsyq)
                                }
                                    if (jsgx1 == "and") {
                                        sql += "  and ";
                                        type(sfljs1, stj1, sjsyq1)
                                    } else if (jsgx1 == "or") {
                                        sql += "  or ";
                                        type(sfljs1, stj1, sjsyq1)
                                    }
                                    ...
                                    if (jsgx5 == "and") {
                                        sql += "  and ";
                                        type(sfljs5, stj5, sjsyq5)
                                    } else if (jsgx5 == "or") {
                                        sql += "  or ";
                                        type(sfljs5, stj5, sjsyq5)
                                    }
                                //alert(sql)
                                function type(mysfljs,mystj,mysjsyq) {
                                    if (mysjsyq==("模糊查询")){
                                        if(mysfljs==("机构全称")){
                                            sql+=" JGMC  like '%"+ mystj+"%'";
                                        }else if(mysfljs==("技术需求名称")){
                                            sql+=" JSXQMC  like '%"+ mystj+"%' ";
                                        }else if(mysfljs==("所在地域")){
                                            sql+=" SZDY  like '%"+ mystj+"%' ";
                                        }else if(mysfljs==("归口管理部门")){
                                            sql+=" GKGLBM  like '%"+ mystj+"%' ";
                                        }else if(mysfljs==("机构属性")){
                                            sql+=" JGSX  like '%"+ mystj+"%' ";
                                        }else if(mysfljs==("科技活动类型")){
                                            sql+=" YJLX  like '%"+ mystj+"%' ";
                                        }
                                    }else {
                                        if(mysfljs==("机构全称")){
                                ...
                                $.ajax({
                                    type:"POST",
                                    url:"${pageContext.request.contextPath}/zhjsServlet",
                                    data:{"sql":sql},
                                    //data:$('#searchForm').serialize(),
                                    dataType:"json",
                                    success:function(data){
