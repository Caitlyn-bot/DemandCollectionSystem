            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                ...
                <div class="panel panel-default" id="report">
                    ...
                    <div id="collapseFour" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingFour">
                        <div class="panel-body">
                            <ul class="list-group">
                                <a class="list-group-item active" href="${pageContext.request.contextPath}/report/fljs.jsp">分类检索</a>
                    ...
                    <form class="form-inline" target="hidden" id="searchForm">
                        ...
                        <script>
                            function search() {
                                ...
                                $.ajax({
                                    type:"POST",
                                    url:"${pageContext.request.contextPath}/fljsServlet",
                                    data:{"sfljs":sfljs,"stj":stj,"sjsyq":sjsyq
                                        ,"sXSSH":sXSSH,"sBMSH":sBMSH},
                                    //data:$('#searchForm').serialize(),
                                    dataType:"json",
                                    success:function(data){
